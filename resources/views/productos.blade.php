...
@section('content')
  <section class="row section-table">
    <div class="col-xs-12">
      <div class="back-post">
        <a href="/admin/categorias" name="post-in" class="btn btn-primary">
      ...
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Productos de la categoría "{{$categoria->nombre}}"</h3>
          <div class="pull-right">
            <button type="button" name="conf-in" class="btn btn-success conf-display" data-val="{{$categoria->id}}">
        ...
        <div class="box-body">
          <table id="productos" class="table table-bordered table-striped table-responsive">
            <thead>
              <tr>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <center>
                    <button type="button" name="producto-edit" class="btn btn-info btn-inline-block" title="Editar" data-val="{{$producto->id}}">
                      <span class="fa fa-pencil"></span>
                    </button>
                    <button type="button" name="producto-del" class="btn btn-danger btn-inline-block" title="Eliminar" data-val="{{$producto->id}}">
      ...
      <div class="box">
        ...
        <div class="box-header">
          <h3 class="box-title" id="title-post">
            Agregar nuevo producto para "{{$categoria->nombre}}"
          </h3>
        </div>
